...
class UserController extends Controller
{
    ...
    public function importCSV()
    {
        ...
        while (($data = fgetcsv($handle, 0, $delimiter)) !== false) {
            ...
            if (
                empty(array_filter($data, function ($cell) {
                    return trim($cell) !== '';
                }))
            ) {
                continue;
    ...
    public function updateKuotaMelahirkan()
    {
        ...
        if ($existing) {
            ...
            if ($sisaPengambilanBaru < 0)
                $sisaPengambilanBaru = 0;
            if ($sisaPengambilanBaru > 3)
                $sisaPengambilanBaru = 3;
            ...
            if ($jumlahPengambilanBaru > 3)
                $jumlahPengambilanBaru = 3;
            if ($jumlahPengambilanBaru < 0)
                $jumlahPengambilanBaru = 0;
