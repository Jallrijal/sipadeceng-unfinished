            ...
            <div class="d-flex gap-2">
                ...
                <div id="tahunKuotaWrapper" style="width: 100px;">
                    ...
                    <select class="form-select form-select-sm" id="tahunKuota">
                        <?php for ($__i = 0; $__i < 3; $__i++): $__y = $__currentYear - $__i; ?>
                            <option value="<?php echo $__y; ?>"><?php echo $__y; ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <button type="button" class="btn btn-warning btn-sm" id="runQuotaManagement" title="Jalankan Pengelolaan Kuota Otomatis" style="display: none;">
                    <i class="bi bi-gear"></i> Reset Quota
                </button>
                <button type="button" class="btn btn-danger btn-sm" id="runQuotaSakit" title="Jalankan Pengelolaan Kuota Cuti Sakit" style="display: none; margin-left:6px;">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    Swal.fire({ icon: 'error', title: 'Test Gagal', html: `
                        <p>Test gagal: ${response.message}</p>
                        <p><strong>File:</strong> ${response.file}</p>
                        <p><strong>Line:</strong> ${response.line}</p>
                    `});
