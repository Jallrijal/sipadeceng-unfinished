                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><?php require_once __DIR__ . '/../../helpers/satker_helper.php'; echo get_nama_satker($leaveData['unit_kerja']); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo formatTanggal($leaveData['tanggal_mulai']); ?> - <?php echo formatTanggal($leaveData['tanggal_selesai']); ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="text-center">
                            <a href="<?php echo baseUrl('leave/downloadSignedDoc?id=' . $leaveId); ?>" 
                               class="btn btn-primary">
                                <i class="bi bi-download me-2"></i>Download Dokumen User
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-light">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Pengajuan telah disetujui.</strong> Silakan upload dokumen yang telah ditandatangani oleh kedua pihak (user dan admin).
                        </div>
                        <?php else: ?>
                        <div class="alert alert-warning">
                            <i class="bi bi-exclamation-triangle me-2"></i>
                            <strong>Pengajuan telah ditolak.</strong> Silakan upload dokumen penolakan yang telah ditandatangani.
                        </div>
                        <?php endif; ?>
                        ...
                        <form id="uploadApprovedForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="approved_document" 
                                       name="approved_document" accept=".pdf" required>
                            ...
                            <div class="alert alert-warning mb-3">
                                <small>
                                    ...
                                    <strong>Penting:</strong> Pastikan dokumen telah ditandatangani dengan benar dan hanya dalam format PDF.
                                </small>
                            </div>
