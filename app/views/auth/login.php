...
<body>
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100" style="background: none;">
        <div class="row w-100" style="max-width: 900px; min-height: 500px; box-shadow: 0 10px 30px rgba(0,0,0,0.15); border-radius: 20px; overflow: hidden; background: #fff;">
            <!-- Left: Login Form -->
            <div class="col-md-6 p-0" style="background: #f7fafc; display: flex; align-items: center;">
                <div class="w-100 px-4 py-5" style="max-width: 400px; margin: 0 auto;">
                    <div class="text-center mb-4">
                        <img src="<?php echo baseUrl('public/images/sipadeceng.png'); ?>" alt="Logo Pengadilan Tinggi Agama Makassar" style="max-width: 80px; height: auto;">
                    ...
                    <form id="loginForm">
                        <div class="mb-4">
                            <label for="username" class="form-label" style="color: #001f4d; font-weight: 600;">Username</label>
                            <div class="form-group">
                                <input type="text" class="form-control" id="username" name="username" placeholder="Masukkan username" required>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label for="password" class="form-label" style="color: #001f4d; font-weight: 600;">Password</label>
                            <div class="form-group">
                        ...
                        <button type="submit" class="btn w-100" style="background: #001f4d; color: #fff; font-weight: 700; font-size: 1.1rem; border-radius: 8px; letter-spacing: 1px;">Login</button>
                    </form>
                </div>
            </div>
            <!-- Right: Illustration -->
            <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center p-0" style="background: #e6eaf3;">
                <div class="text-center w-100">
                    <img src="<?php echo baseUrl('public/images/login.jpeg'); ?>" alt="Welcome Illustration" style="max-width: 320px; width: 90%; margin-bottom: 30px;">
                    <div style="font-size: 2rem; font-weight: 700; color: #001f4d; letter-spacing: 2px;">SIPADECENG</div>
                    <div style="color: #555; font-size: 1.1rem; margin-top: 10px;">Sistem Pengelolaan Data Elektronik Cuti<br>Pengadilan Tinggi Agama Makassar</div>
                </div>
            </div>
        </div>
    </div>
