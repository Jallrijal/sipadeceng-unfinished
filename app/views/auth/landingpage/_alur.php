<!-- Alur Proses Pengajuan Cuti Modern -->
<section id="alur" class="section-alur-new">
	<div class="container">
		<div class="row">
			<!-- Left Sticky Info -->
				...
				<div class="alur-sticky-wrapper">
					...
					<div class="alur-circular-wrapper mt-5 d-none d-md-flex" data-aos="fade-up" data-aos-delay="200">
						...
						<svg class="alur-circular-text" viewBox="0 0 100 100">
							<path d="M 50,50 m -37,0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" id="circle-path-alur" fill="none"></path>
							<text font-size="10.5" font-weight="600" letter-spacing="2.5" fill="#475569">
								<textPath href="#circle-path-alur">SIPADECENG • PROSES MUDAH • SIPADECENG • PROSES CEPAT • </textPath>
							</text>
						</svg>
					</div>
				</div>
			...
			<div class="col-lg-6 offset-lg-1" data-aos="fade-left">
				<div class="alur-scroll-container" id="alur-scroll-container">
					...
					<!-- Card 02 -->
					<div class="alur-item" data-step="2">
						<div class="alur-item-bg"></div>
						<div class="alur-item-content">
							<div class="alur-text">
					...
					<!-- Card 03 -->
					<div class="alur-item" data-step="3">
						<div class="alur-item-bg"></div>
						<div class="alur-item-content">
							<div class="alur-text">
					...
					<!-- Card 04 -->
					<div class="alur-item" data-step="4">
						<div class="alur-item-bg"></div>
						<div class="alur-item-content">
							<div class="alur-text">
