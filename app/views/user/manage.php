    ...
    <div class="card-body">
        ...
        <div class="alert alert-info mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <span class="badge bg-danger">Non-Aktif</span> - User tidak dapat login (gunakan Edit untuk mengubah status)
                </div>
                <div class="col-md-3">
                    <span class="text-muted"><i class="bi bi-exclamation-triangle me-1"></i>Tombol Hapus = Hapus Permanen</span>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    <strong>Cara Kerja:</strong> Sistem akan menentukan atasan langsung untuk setiap pegawai secara otomatis berdasarkan jabatan mereka, sesuai dengan hierarki organisasi yang sudah dikonfigurasi.
                </div>
                <p class="fw-semibold mb-2">Pilih Mode Sinkronisasi:</p>
                <div class="form-check mb-2">
                    <input class="form-check-input" type="radio" name="syncMode" id="modeOnlyNull" value="only_null" checked>
                ...
                <div class="form-check mb-3">
                    ...
                    <label class="form-check-label" for="modeAll">
                        ...
                        <div class="text-muted small">Akan mengganti atasan yang sudah ada dengan hasil deteksi otomatis</div>
                    </label>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs mb-3" id="syncResultTabs">
                    <li class="nav-item">
                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#syncTabBerhasil">                            <i class="bi bi-check-circle text-success me-1"></i>Berhasil <span class="badge bg-success ms-1" id="tabBadgeBerhasil">0</span>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#syncTabTidakCocok">
                            <i class="bi bi-question-circle text-warning me-1"></i>Tidak Cocok <span class="badge bg-warning ms-1" id="tabBadgeTidakCocok">0</span>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#syncTabError">
                            <i class="bi bi-x-circle text-danger me-1"></i>Error <span class="badge bg-danger ms-1" id="tabBadgeError">0</span>
                        </button>
                    </li>
                </ul>
                <div class="tab-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-striped" id="syncTableBerhasil">
                                <thead class="table-success">
                                    <tr><th>No</th><th>Nama</th><th>Jabatan</th><th>Atasan Baru</th><th>Jabatan Atasan</th></tr>
                                </thead>
                    ...
                    <div class="tab-pane fade" id="syncTabTidakCocok">
                        <div class="alert alert-warning">
                            ...
                            <strong>Tips:</strong> User-user berikut jabatannya tidak cocok dengan aturan hierarki. Periksa format jabatan mereka atau pilih atasan secara manual saat edit user.
                        </div>
                        <div class="table-responsive">
                            <table class="table table-sm table-striped" id="syncTableTidakCocok">
                                <thead class="table-warning">
                                    <tr><th>No</th><th>Nama</th><th>Jabatan</th><th>Keterangan</th></tr>
                                </thead>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="$('#syncResultModal').modal('hide'); loadUsers();">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div class="form-text">Format file harus CSV dengan encoding UTF-8. Mendukung delimiter comma (,) dan semicolon (;)</div>
                </div>
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0 mt-2">
                        <li><strong>Deteksi Otomatis:</strong> Sistem akan mendeteksi delimiter (comma/semicolon) secara otomatis</li>
                        <li><strong>Skip Header Non-Data:</strong> Baris kosong dan header non-data akan di-skip otomatis</li>
                        ...
                        <li><strong>Password Default:</strong> Semua user akan memiliki password "password" (ter-hash)</li>
                        ...
                        <li><strong>Update Data Existing:</strong> Jika NIP sudah ada, data akan diupdate (termasuk perpindahan unit kerja)</li>
                        <li><strong>Username Dinamis:</strong> Username akan diupdate sesuai unit kerja baru</li>
                        <li><strong>Pindah Unit Kerja:</strong> Saat user berpindah unit kerja, semua kuota cuti ikut berpindah</li>
                    </ul>
                </div>
                ...
                <div class="alert alert-success">
                    ...
                    <ul class="mb-0 mt-2">
                        ...
                        <li>Saat unit kerja berubah, semua kuota cuti (tahunan, sakit, besar, melahirkan, alasan penting, luar tanggungan) ikut berpindah</li>
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" id="importResultTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="success-tab" data-bs-toggle="tab" data-bs-target="#success-content" type="button" role="tab" aria-controls="success-content" aria-selected="true">
                            ...
                            <li class="nav-item ms-auto" role="presentation">
                                <button class="btn btn-sm btn-outline-secondary" onclick="exportImportResult()" title="Export Hasil Import">
                        ...
                        <div class="tab-content" id="importResultTabContent">
                            <div class="tab-pane fade show active" id="success-content" role="tabpanel" aria-labelledby="success-tab">
...
@media (max-width: 576px) {
    ...
    #usersTable_wrapper .dataTables_length select {
        width: 64px !important; /* small fixed width for mobile */
